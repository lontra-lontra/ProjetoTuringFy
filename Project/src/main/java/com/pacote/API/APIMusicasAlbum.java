...
public class APIMusicasAlbum {
	...
	public class APIdaPaginaInicial {	
		...
		public MusicaParaEnviar[] musicasDeUmAlbum(@RequestParam(name="albumID", required=false, defaultValue=" ") String userToken){
			int quantidade = 20;
			Track[] userLists = new Track[quantidade];
			userLists = Comunicador.getAlbunsTracks(userToken);
